...
<a href="index.php" class="brand-link"><span class="brand-text font-weight-light">SIAKAD Dosen</span></a>
<div class="sidebar">
<nav class="mt-2">
...
<li class="nav-item"><a href="nilai.php" class="nav-link <?= basename($_SERVER['PHP_SELF'])=='nilai.php'?'active':'' ?>"><i class="nav-icon fas fa-edit"></i><p>Isi Nilai</p></a></li>
</ul>
</nav>
</div>
</aside>
